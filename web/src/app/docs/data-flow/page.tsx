...
export default function DataFlowPage() {
    return (
        <>
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Flujo de Datos</h1>
            ...
            <div className="prose prose-blue max-w-none">
                ...
                <h2 className="mt-8">El Pipeline de Streaming</h2>
                <p>
    ...
    Batch -->|Prefetch| GPU["Memoria GPU/MPS"]`} />
                ...
                <h2 className="mt-8">Componentes Clave</h2>

                <h3 className="text-xl font-semibold mt-6 mb-3">1. Shards de WebDataset</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3">2. Procesamiento al Vuelo</h3>
                <p>
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3">3. Optimizaciones para Hardware Heterogéneo</h3>
                <p>
                ...
                <h2 className="mt-8">Eficiencia de Red</h2>
                <p>
